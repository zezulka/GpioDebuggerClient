...
public class UserDataUtils {
    ...
    private static final File DEVICES_FILE = new File("src" + File.separatorChar
            + "main" + File.separatorChar
            + "resources" + File.separatorChar + "devices.xml");
    ...
    private static void initXStream() {
        ...
        X_STREAM.addImplicitCollection(Devices.class, "devices", DeviceValueObject.class);
    }
    ...
    public static void putNewDeviceEntryIntoCollection(DeviceValueObject address) {
