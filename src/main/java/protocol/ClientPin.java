...
public interface ClientPin {
     ...
     * for internal identification of all pins. When the pin is GPIO, this identifier 
    ...
    String getPinId();
    /**
     * Name which makes it easy for user to recognise GPIO pin. It is advised that 
